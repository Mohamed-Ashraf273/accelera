...
def create_ard_regression_hyperparameters():
    return [
        ...
        UniformIntegerHyperparameter("ard_regression:max_iter", lower=100, upper=1000),
...
REGRESSION_COMPONENTS = {
    "adaboost": RegressionComponent("adaboost", create_adaboost_hyperparameters, create_adaboost_conditions, build_adaboost),
    "ard_regression": RegressionComponent("ard_regression", create_ard_regression_hyperparameters, create_ard_regression_conditions, build_ard_regression),
    "decision_tree": RegressionComponent("decision_tree", create_decision_tree_hyperparameters, create_decision_tree_conditions, build_decision_tree),
    "extra_trees": RegressionComponent("extra_trees", create_extra_trees_hyperparameters, create_extra_trees_conditions, build_extra_trees),
    "gaussian_process": RegressionComponent("gaussian_process", create_gaussian_process_hyperparameters, create_gaussian_process_conditions, build_gaussian_process),
    "gradient_boosting": RegressionComponent("gradient_boosting", create_gradient_boosting_hyperparameters, create_gradient_boosting_conditions, build_gradient_boosting),
    "k_nearest_neighbors": RegressionComponent("k_nearest_neighbors", create_knn_hyperparameters, create_knn_conditions, build_knn),
    "liblinear_svr": RegressionComponent("liblinear_svr", create_liblinear_svr_hyperparameters, create_liblinear_svr_conditions, build_liblinear_svr),
    "libsvm_svr": RegressionComponent("libsvm_svr", create_libsvm_svr_hyperparameters, create_libsvm_svr_conditions, build_libsvm_svr),
    "mlp": RegressionComponent("mlp", create_mlp_hyperparameters, create_mlp_conditions, build_mlp),
    "random_forest": RegressionComponent("random_forest", create_random_forest_hyperparameters, create_random_forest_conditions, build_random_forest),
    "sgd": RegressionComponent("sgd", create_sgd_hyperparameters, create_sgd_conditions, build_sgd),
}
