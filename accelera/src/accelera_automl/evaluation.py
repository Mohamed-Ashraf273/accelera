...
from .base_evaluation import EvaluationResult
from .base_evaluation import TrialSpecs
...
class ClassificationEvaluator(BaseEvaluation):
    ...
    def build_estimator(self,model_name,params,trial_specs):
            ...
            est = cls_component.build_estimator(params,self.random_state,self.n_jobs,self.balance_classes)
    ...
    def get_cv_splitter(self, cv_num_of_splits):
        return StratifiedKFold(n_splits=cv_num_of_splits, shuffle=True, random_state=self.random_state)
...
class RegressionEvaluator(BaseEvaluation):
    ...
    def get_cv_splitter(self, cv_num_of_splits):
        return KFold(n_splits=cv_num_of_splits, shuffle=True, random_state=self.random_state)
