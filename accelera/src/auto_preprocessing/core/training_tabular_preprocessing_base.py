...
from accelera.src.auto_preprocessing.core.tabular_preprocessing_base import (
...
class TrainingTabularPreprocessingBase(TabularPreprocessingBase):
    def __init__(
        ...
        if self.target_col not in self.df.columns:
            raise ValueError(f"target_col {target_col} must be one of the dataframe columns {self.df.columns}")
