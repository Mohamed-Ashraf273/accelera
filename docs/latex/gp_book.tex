...
Mohamed Ashraf \hfill  & Nesma Osama \hfill  \\
Mazen Adel \hfill & Mohamed Khater \hfill  \\
\end{tabular}\\[0.4cm]
...
Accelera is a machine learning toolkit that provides a set of modules designed to help users through different stages of the data science workflow. the system allows users to access and use each module according to their specific needs.
The toolkit consists of six main modules that automate repetitive tasks often exist in machine learning projects. These modules aim to reduce manual effort, improve productivity, and speed up experimentation and model development.
Each module has its own set of assumptions, which will be listed separately.
