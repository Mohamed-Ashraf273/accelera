...
The Benchmark Platform module was tested by checking its main functionality. Unit tests were not used for this module. Instead, the module was tested by submitting different model results and checking if they were saved and displayed correctly.
The testing focused on making sure that the platform can receive the submitted result, store the dataset name, metric name, and score, and then show the result in the leaderboard. The leaderboard was also checked to make sure that the results were ordered and displayed in a clear way.
This testing showed that the Benchmark Platform module worked as expected and was able to submit results and display them correctly in the leaderboard.
...
analysis, OpenMP, NumPy,Pandas, Matplotlib,pytorch,  Scikit-learn , Node.js, and React ,MongoDB. The available experiments include
