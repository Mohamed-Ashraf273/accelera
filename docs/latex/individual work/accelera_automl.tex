...
Table~\ref{tab:regression-results} reports the stored regression summary. TPOT
obtained the highest mean $R^2$ at 0.5671, followed by Auto-sklearn at 0.5478
and Accelera at 0.5351. Accelera completed the recorded tasks in a mean of
284.3 seconds, compared with approximately 1,800 seconds for each competing
system. Thus, on the available measurements, Accelera traded a modest reduction
in average predictive quality for a substantial reduction in runtime.

\begin{table}[H]
\centering
\caption{Regression benchmark summary from the stored experiment results.}
...
\midrule
TPOT         & 0.567064 & 0.455565 & 1805.54 & 2 & 2 & 2 & 0 \\
Auto-sklearn & 0.547839 & 0.469324 & 1829.64 & 2 & 2 & 2 & 0 \\
Accelera     & 0.535125 & 0.426184 &  284.26 & 1 & 1 & 1 & 5 \\
FLAML        & 0.527313 & 0.436010 & 1803.80 & 0 & 0 & 0 & 0 \\
\bottomrule
\end{tabular}
}
\end{table}
...
Auto-sklearn, and the regression results show a moderate $R^2$ difference
relative to TPOT, accompanied in both cases by substantial runtime reductions.
