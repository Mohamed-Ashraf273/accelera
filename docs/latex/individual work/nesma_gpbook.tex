...
\noindent This project focuses on improving these steps inside Accelera. It aims to support the user during data preprocessing, pipeline execution, pipeline reporting, and benchmarking. The Auto Preprocessing module prepares different types of datasets for machine learning tasks. The Accelera Pipeline module includes metric nodes for calculating evaluation results and reporting classes for presenting pipeline outputs in a clear form using reports, graphs, tables, and metric summaries. The Benchmarking module gives users a fair way to submit their predictions and compare their results using the same evaluation rules.\\
...
This chapter explains the design of the modules included in this individual report. The main modules are Auto Preprocessing, the Accelera Pipeline module, and the Benchmarking Platform.
...
\end{itemize}
\subsection{Accelera Pipeline Module Assumptions}
 
The Accelera Pipeline module depends on the following assumptions:
...
This section explains the implemented modules in this report. It discusses the three main parts: Auto Preprocessing, the Accelera Pipeline module, and Benchmarking. For each module, the section explains module overview and how it works.
...
\section{Accelera Pipeline Module}

\subsection{Metric Node Wrappers}

Metric nodes are part of the Accelera pipeline execution. They are responsible
...
the Accelera Pipeline module, and the Benchmarking module in Accelera. The
...
\noindent The Accelera Pipeline module includes metric nodes and pipeline
