...
{\fontsize{12}{14}\selectfont June 28, 2026}
...
\section{Using Metric Nodes in Accelera Pipeline}

\begin{lstlisting}[style=code,caption={Creating metric results from metric nodes}]
from sklearn.metrics import accuracy_score
from sklearn.metrics import silhouette_score

from accelera.src.accelera_pipe.wrappers.supervised_metric import SupervisedMetric
from accelera.src.accelera_pipe.wrappers.unsupervised_metric import UnSupervisedMetric

accuracy_node = SupervisedMetric(
    metric_name="Accuracy",
    metric=accuracy_score,
    y_true=y_test,
)
accuracy_result = accuracy_node.execute(y_pred)

silhouette_node = UnSupervisedMetric(
    metric_name="Silhouette Score",
    metric=silhouette_score,
)
silhouette_node.set_X(X_cluster)
silhouette_result = silhouette_node.execute(cluster_labels)

metric_results = [accuracy_result, silhouette_result]
\end{lstlisting}
