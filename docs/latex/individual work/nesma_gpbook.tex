...
the Pipeline Reporting module, and the Benchmarking module in Accelera. The
...
\noindent The Pipeline Reporting module helps make pipeline outputs easier to
understand. Instead of leaving the user with only terminal output, it generates
HTML reports, graph images, tables, and metric displays. This is useful when
the workflow contains branches or different metric result types. The
