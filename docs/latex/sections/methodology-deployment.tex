...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{imgs/orchestration_flow.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{imgs/vcs_flow.pdf}
\caption{Model Version Control System (VCS) Workflow}
\label{fig:vcs_flow}
\end{figure}
