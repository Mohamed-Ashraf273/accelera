...
\subsubsection{Tabular Dataset Training}
...
\vspace{1cm}
\Needspace{5\baselineskip}
\subsubsection{Tabular Dataset Testing}
...
\subsubsection{Text Dataset Training}
...
\end{lstlisting}
\subsubsection{Text Dataset Testing}
...
\end{tabular}
\end{table}
\subsubsection{Image Dataset Training}
...
\vspace{1cm}
\Needspace{5\baselineskip}
\subsubsection{Image Dataset Testing}
