...
\vspace{1cm}
\Needspace{4\baselineskip}
\noindent\textbf{Feature Selection:}\par
...
The auto preprocessed image pipeline is designed to handle two types of vision tasks: image classification and binary segmentation.
\vspace{1cm}
\Needspace{4\baselineskip}
\noindent\textbf{Expected Dataset Structure}
...
\vspace{1cm}
\Needspace{4\baselineskip}
\noindent\textbf{Classification image training preprocessing steps:}\par
\begin{enumerate}
\item Initialize the constructor and validate input parameters.
  \item Generate class-label mappings.
    ...
    \item Create dataset overview and summary statistics.
...
\vspace{1cm}
\Needspace{4\baselineskip}
\noindent\textbf{Initialize the constructor and validate input parameters:}\par
