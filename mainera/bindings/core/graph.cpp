...
PYBIND11_MODULE(graph, m) {
    ...
    py::class_<Graph>(m, "Graph")
        ...
        .def("split",
             &Graph::split,
             py::arg("branch_name"),
             py::arg("branch_objects"),
             py::arg("node_types"),
             py::arg("node_names"),
             "Split the graph into branches")
        ...
        .def("enableParallelExecution",
             &Graph::enableParallelExecution,
             py::arg("enable") = true,
             "Enable or disable parallel execution")

        .def("setMulticoreThreshold",
             &Graph::setMulticoreThreshold,
             py::arg("threshold"),
