...
void Node::setData(py::object result)
{
    m_data = result;
}

py::object Node::getData() const
{
    return m_data;
}
...
bool Node::getShouldCreateNewData() const
{
    return should_create_new_data;
}

void Node::setUsesGPU(bool uses_gpu)
{
    m_uses_gpu = uses_gpu;
}

bool Node::getUsesGPU() const
{
    return m_uses_gpu;
}
