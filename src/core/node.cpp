...
void Node::setSourceNode(std::shared_ptr<Node> source) { m_sourceNode = source; }
...
void Node::setShouldCreateNewData(bool should_create) { should_create_new_data = should_create; }
